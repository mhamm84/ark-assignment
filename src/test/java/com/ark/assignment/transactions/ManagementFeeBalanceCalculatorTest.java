...
class ManagementFeeBalanceCalculatorTest {

    private ManagementFeeCalculator underTest;

    @BeforeEach
    public void setup() {
        underTest = new ManagementFeeCalculator();
    }
    ...
    void transactionType() {
        assertEquals(underTest.transactionType(), TransactionType.MANAGEMENT_FEE);
    }
}